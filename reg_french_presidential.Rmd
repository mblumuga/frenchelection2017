...
#To see departments with largest discrepancies with expected values
#mm[order(mm$mean, decreasing = F), ]

dep <- sf::st_read("data/shapefile/DEPARTEMENT.shp")
test<-match(dep$CODE_DEPT,mm$dep)
...
plotly::api_create(gg, tooltip = c("text"),filename = "excessvotes_France")
...
By contrast, the departments where the score of Le Pen are much lower than the predictions based on socio-economic vales are Paris (75, -6.7%), Haut-de-Seine (92? -2.7%), Indre-et-Loire (37, -2.6%), Seine-Saint Denis (93, -2.1%), Hautes-Alpes (-2.0%). It is clear that in and around Paris, Le Pen scores are not as large as they should be and economy is not the sole explanantion.
